    ...
    newTaskForm.on('submit', function (e) {
      ...
      if (isValid) {
        ...
        var assignedTo = $('#task-assigned').val(),
          todoBadge = '',
          membersImg = {
            'Phill Buffer': assetPath + 'images/portrait/small/avatar-s-3.png',
            'Chandler Bing': assetPath + 'images/portrait/small/avatar-s-1.png',
            'Ross Geller': assetPath + 'images/portrait/small/avatar-s-4.png',
            'Monica Geller': assetPath + 'images/portrait/small/avatar-s-6.jpg',
            'Joey Tribbiani': assetPath + 'images/portrait/small/avatar-s-2.png',
